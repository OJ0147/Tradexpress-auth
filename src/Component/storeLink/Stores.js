        ...
        <div className="linkss">
          ...
          <div className="stores">
            <div className='storelinks'>
              <a href={applink}><img src={AppleLogo} alt="appstore" /><p><small>Download on the</small><br /> App Store</p></a>
            </div>
            <div className='storelinks'>
              <a href={googlelink} ><img src={GoogleLogo} alt="googlestore" /> <p><small>Get on</small><br /> Google Play</p></a>
            </div>
          </div>
